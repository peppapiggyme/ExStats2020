...
void Exercise_3::test() const
{
    ...
    // plotting
    TCanvas * c1 = new TCanvas( "c1_ex3", "m_{4l}", 800, 600);
    ...
    c1->SaveAs(std::string("../plots/Ex3_m4l_H125.png").c_str());
    ...
    TH1D* hEvent = new TH1D("Ex3_h", "", 100, 0, 100);
    ...
    TH1D* hEventMu = new TH1D("Ex3_h_mu", "", 100, 0, 100);
    mu = 1.; // H1
    for (unsigned long i = 0; i < nToys; i++)
    {
        double nuRandom = r.Gaus(0, 1);

...
// Fri Nov 27 20:22:41 2020 by ROOT version 6.22/02
// from TTree mini/mini
// found on file: ../res/mc_345060.ggH125_ZZ4lep.4lep.root
//////////////////////////////////////////////////////////
...
public:
   static unordered_map<string, float> mapLumiWeights;
   static void getLumiWeights(const string& sFileName, float fLumi)
   {
       ifstream ifs(sFileName);
       string sLine;
       while(getline(ifs, sLine))
       {
           if (sLine.find("#") != string::npos) { continue; }
           string sName, sXSec, sSumw, sEff;
           string sRemain;
